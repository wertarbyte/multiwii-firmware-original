...
void tinygps_query(void) {
  ...
  if (i2c_errors == i2c_errors_count) {
    ...
    flag.GPS_FIX = (navi.gps.quality > 0);
...
void Sonar_update() {
  if (currentTime < srf08_ctx.deadline || (srf08_ctx.state==0 && flag.ARMED)) return; 
